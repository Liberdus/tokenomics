...
<div className="bg-white min-h-screen w-full">
  ...
  <div className="container mx-auto lg:px-4 flex flex-col lg:flex-row gap-4">
  ...
  className="flex flex-col border-l-4 border-purple py-2 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4">
      ...
      <h2 className="text-xl font-semibold text-purple">Network Parameters</h2>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1">
          ...
          {/* Network Section */}
<div className="p-2 p-4 rounded-lg shadow">
...
<div className="p-4 rounded-lg mt-4 shadow">
  ...
  <div className="form-control min-h-200">
    ...
    <div className="bg-white  rounded-lg lg:sticky top-4 h-fit lg:w-1/2">
                  <div
  aria-current="step"
  className="flex flex-col border-l-4 border-purple py-2 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4">


  <div className="min-w-full apr-stats">

    <h2 className="pt-0 text-xl font-semibold text-purple">Node Income</h2>


    <dl className="grid grid-cols-2 gap-5 sm:grid-cols-2 lg:grid-cols-2">
      <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt className="truncate text-sm font-medium text-gray-500">Revenue/day</dt>
        <dd className="mt-1 lg:text-3xl font-semibold tracking-tight text-gray-900 break-words">
  ...
  <div className="flex-1 min-w-full">
    ...
    <dl className="mt-5 grid grid-cols-2 gap-5 sm:grid-cols-2 lg:grid-cols-2">
      ...
      <div className="overflow-hidden rounded-lg bg-white px-4 py-5 shadow sm:p-6">
        <dt className="truncate text-sm font-medium text-gray-500">Delta LIB/day</dt>
        <dd className="mt-1 lg:text-3xl font-semibold tracking-tight text-gray-900 break-words">
          {this.state.NetworkDeltaPerDay.toFixed(0) + " LIB"}
        </dd>
        <p className="mt-2 text-sm text-gray-500">LIB Delta = Income / Stability factor</p>
      </div>
    </dl>
  </div>
</div>
