  ...
  <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 text-base/7 text-lightGrey">
    ...
    <div>
      ...
      <ul className="list-decimal space-y-2 list-inside mt-2">
        ...
        <li>Tokens <a href="https://liberdus.com/tokenomics/#/faq#faq-10" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">slashed</a> from misbehaving validators are permanently removed.</li>
...
<div className="mt-10 lg:col-span-2 border-l-4 border-purple py-4 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-6 text-base/7 text-lightGrey">
  ...
  <p className="mt-4">
    To achieve this, the network requires a pool of <a href="https://liberdus.com/tokenomics/#/faq#faq-11" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">standby nodes</a> that are ready to join as demand increases. 
    However, since <a href="https://liberdus.com/tokenomics/#/faq#faq-11" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">standby nodes</a> do not earn rewards, the incentives for active validator nodes must be sufficient to offset standby periods and ensure profitability.
  </p>
  <p className="mt-4">
    If the standby pool is insufficient, active validators can become overloaded, leading the network to reject transactions due to excessive traffic. To prevent this, the network needs the ability to adjust validator rewards to maintain a steady supply of <a href="https://liberdus.com/tokenomics/#/faq#faq-11" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">standby nodes</a>, ensuring scalability.
  </p>
...
<div className="mt-10 lg:col-span-2 border-l-4 border-purple py-4 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-6">
  ...
  <div className="mt-8">
    <p className="mb-4">
      In the Liberdus network, APY% is expected to naturally find equilibrium over time. When the network is highly profitable, the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> would increase, ensuring a surplus of <a href="https://liberdus.com/tokenomics/#/faq#faq-11" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">standby nodes</a>. Conversely, if profitability declines, the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> would decrease as fewer validators remain in standby.
    </p>

    <p>
      The graphs below illustrate how native token price fluctuations impact the network's scalability and efficiency. In a <span className="font-semibold">bull case scenario</span> (similar to Ethereum), the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> may become excessively high, leading to unnecessary computational waste. On the other hand, in a <span className="font-semibold">bear case scenario</span> (similar to Algorand), a low <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> could threaten network security and hinder scalability, potentially reducing transaction throughput (TPS).
    </p>
  </div>
  ...
  <div className="mt-10">
    ...
    <ul className="list-disc space-y-2 list-inside mt-2">
      ...
      <li>Maintain the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> at a level that preserves Liberdus’s ability to scale without compromising security.</li>
      <li>Prevent excessive LIB issuance by keeping the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> optimized, avoiding unnecessary waste of computational and natural resources.</li>
...
<div className="mt-10 lg:col-span-2 border-l-4 border-purple py-4 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-6">
  ...
  <p className="mt-2">
    The research above highlights that controlling the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> and maintaining supply equilibrium are critical for ensuring an efficient and stable network. Since it is impossible to predict every variable to create a predefined issuance schedule, Liberdus introduces a small set of adjustable network parameters overseen by the <a href="https://liberdus.com/tokenomics/#/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a>:
  </p>
  ...
  <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 text-base/7 text-lightGrey">
    ...
    <div>
      ...
      <ul className="list-disc space-y-2 list-inside mt-2">
        ...
        <li>Increasing the node reward per hour allows the network to sustain more validator nodes, increasing the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a>.</li>
        <li>Decreasing the node reward per hour reduces the number of active nodes, decreasing the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a>.</li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="list-disc space-y-2 list-inside mt-2">
        <li>Some or all of the stake can be <a href="https://liberdus.com/tokenomics/#/faq#faq-10" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">slashed</a> if the node misbehaves or fails to process transactions efficiently.</li>
        <li>Adjusting this parameter impacts the APY% for node operators, making running a node more or less profitable.</li>
        <li>If running a node becomes more profitable, more nodes will join, increasing the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a>.</li>
        <li>If running a node becomes less profitable, fewer nodes will participate, reducing the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a>.</li>
      </ul>
    </div>
  </div>
  ...
  <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 text-base/7 text-lightGrey items-stretch">
    ...
    <div className="flex flex-col h-full">
      <div className="flex-grow">
        ...
        <p className="mt-2">
          This simulation demonstrates how adjusting a single <a href="https://liberdus.com/tokenomics/#/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a>-governed parameter can help the network maintain economic balance.
        </p>
        <p className="mt-2">
  ...
  <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 text-base/7 text-lightGrey items-stretch">
    ...
    <div className="flex flex-col h-full">
      <div className="flex-grow">
        <h3 className="text-lg font-semibold">Supply Equilibrium Adjustments</h3>
        <p className="mt-2">
          This simulation demonstrates how the <a href="https://liberdus.com/tokenomics/#/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> can restore network balance by fine-tuning transaction fee ($) and node reward ($/hr) parameters.
        </p>
        <p className="mt-2">
...
<div className="mt-10 lg:col-span-2 border-l-4 border-purple py-2 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4">
  ...
  <p className="mt-2">
    In every scenario, the model naturally found equilibrium (LIB burned = LIB issued) or required only minor adjustments to <a href="https://liberdus.com/tokenomics/#/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a>-overseen parameters to stabilize.
  </p>
  ...
  <div className="mt-6 text-center">
    <a href="/tokenomics/#/simulations" className="text-purple font-semibold hover:underline">
...
<div className="mt-10 lg:col-span-2 border-l-4 border-purple py-2 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-4">
  ...
  <p className="mt-4">
    Through extensive simulations, we have validated that maintaining validator profitability, achieving supply equilibrium, and optimizing the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> are crucial for the long-term sustainability of Liberdus.
  </p>
  <p className="mt-2">
  ...
  <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 text-base/7 text-lightGrey">
    ...
    <div>
      ...
      <p className="mt-2">
        Simulations confirm that validator profitability is essential for network stability. When profitability declines, the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a>(Standby-to-Active Nodes) drops, leading to fewer validators and reduced scalability.
      </p>
      <p className="mt-2">
      ...
      <p className="mt-2">
        A high <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> ensures decentralization and network robustness, but excessive standby validators can result in unnecessary token issuance.
      </p>
      <p className="mt-2">
    ...
    <div>
      ...
      <p className="mt-2">
        If the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> is too high, excess LIB issuance occurs, leading to resource inefficiencies.
      </p>
      <p className="mt-2">
      ...
      <p className="mt-2">
        The simulations highlight how adjusting the <a href="https://liberdus.com/tokenomics/#/faq#faq-12" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">S:A ratio</a> helps maintain validator efficiency under different market conditions.
      </p>
      <p className="mt-2">
