        ...
        <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 items-stretch text-base/7 text-lightGrey">
          ...
          <div>
            ...
            <ul className="list-disc space-y-2 list-inside">
              ...
              <li>
                <span className="font-semibold">10%</span> – To Shardus token holders (ULT) (created when needed by <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> after mainnet; distributed over 2 years with multiple claim events).
              </li>
            </ul>
          </div>
          {/* End Left Column */}
          ...
          <div className="lg:mt-16">
            <ul className="list-disc space-y-2 list-inside">
              <li>
                <span className="font-semibold">25%</span> – To other communities (created when needed by <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> after mainnet; distributed over 2 years; claim events occur over 2 years and are verified on x.com to prevent multiple claims).
              </li>
              <li>
                ...
                <p className="mt-2">
                  All creation and use of minted coins must be approved by the <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a>. Coins burned by tx_fees, penalties, and voting are added to this pool, and unused amounts from other items will be added to this pool.
                </p>
              </li>
            </ul>
              <p className="mt-2">
...
<div className="mt-10 max-w-xl lg:max-w-none border-l-4 border-purple py-4 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-6">
  ...
  <div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 items-stretch text-base/7 text-lightGrey">
    ...
    <div>
      ...
      <p className="mt-2 mb-4">
        A group of 4 to 10 committers will be responsible for maintaining the repositories and approving pull requests. During this phase, the committers vote on the project's direction, while after mainnet launch, the <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> will take over decision-making, with committers assisting in executing those decisions.
      </p>
...
<div className="mt-10 max-w-xl lg:max-w-none border-l-4 border-purple py-4 pl-4 md:border-l-0 md:border-t-4 md:pb-0 md:pl-0 md:pt-6">
  ...
  <p className="my-4">
    After the mainnet launch, the Liberdus ERC20 tokens on Polygon will continue to exist, and a bridging mechanism will allow these tokens to be converted into coins on the mainnet, and vice versa. On mainnet, node operators are rewarded with newly minted coins. The <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> also retains the authority to vote on proposals to mint coins for other purposes, such as development and maintenance of the Liberdus and Shardus codebases, providing liquidity for LIB on AMMs, covering operational expenses like servers, marketing efforts to raise awareness of Liberdus, and ecosystem grants for building additional services and software.
    </p>
...
<div className="grid grid-cols-1 gap-6 md:gap-8 lg:grid-cols-2 items-stretch text-base/7 text-lightGrey">
  ...
  <div>
    <ul className="list-disc space-y-2 list-inside">
      <li>
        <span className="font-semibold">Other Communities</span> – After the Mainnet launch, the <a href="/faq#faq-13" target="_blank" rel="noopener noreferrer" className="text-blue-500 underline">LDAO</a> will distribute coins to other communities as needed. As the issuance schedule is uncertain, a linear distribution (fixed daily amounts) will also be used until the maximum supply of 52.5 million coins is reached. However, these distributions are expected to occur less frequently but in larger amounts.
      </li>
